...
func (p *NfrTrafficFilterProvider) CleanupVRFRules(ctx context.Context, req provider.CleanupVRFRulesRequest) error {
...
func validateCleanupVRFRulesRequest(req provider.CleanupVRFRulesRequest) error {
	if req.VNI == 0 {
